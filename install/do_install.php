...
if (isset($_POST)) {
    ...
    */
    ...
    if (!is_file('../sql/latest.sql')) {
        echo json_encode(array("success" => false, "message" => "The latest.sql file could not found in install folder!"));
        exit();
    }
    ...
    $sql = file_get_contents("latest.sql");
